<aside class="fixed inset-y-0 left-0 bg-gray-900 w-64 hidden lg:block shadow-2xl z-50">
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            ...
            <a href="/peserta" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition {{ Request::is('peserta*') ? 'bg-red-600 text-white shadow-lg shadow-red-900/20' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                ...
                <span class="{{ Request::is('peserta*') ? 'font-bold' : 'font-medium' }} text-sm">Data Peserta</span>
            </a>
